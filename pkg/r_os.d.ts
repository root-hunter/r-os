/* tslint:disable */
/* eslint-disable */
export function receive_line(line: string): void;
...
export interface InitOutput {
  ...
  readonly receive_line: (a: number, b: number) => void;
  readonly start: () => void;
  ...
  readonly wasm_bindgen__convert__closures_____invoke__hbd646fb2cd058599: (a: number, b: number) => void;
